...
// import 'package:markets/src/elements/ProductGridItemWidgetTest.dart';
...
// TODO add layout in configuration file
  ...
  Future _loadData() async {
    ...
    print("load more category products! " +
    ...
    skip += take;
    _con.listenForProductsByCategory(skip, 10, id: widget.routeArgument.id);
    isLoading = false;
    // setState(() {
    //   items
  ...
  void initState() {
    _con.listenForCart().then((value) {
      _con.listenForProductsByCategory(0, 10, id: widget.routeArgument.id);
    ...
    return Scaffold(
      ...
      body: NotificationListener<ScrollNotification>(
        ...
        child: RefreshIndicator(
          onRefresh: () async {
            _con.refreshCategory(widget.routeArgument.id);
              ...
              children: <Widget>[
                Padding(
                  ...
                  child: SearchBarWidget(onClickFilter: (filter) {
                    //TESTT HIDE FILTER TAP FUNCTION
