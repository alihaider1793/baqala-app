                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                                    ...
                                    onTap: () {
                                      setState(() {
                                        _con.marketReview.rate =
                                            (index + 1).toString();
                                        if (_con.marketReview.rate == '1') {
                                          _con.marketRating =
                                              'Delivers in more than 60 minutes';
                                        }
                                        if (_con.marketReview.rate == '2') {
                                          _con.marketRating =
                                              'Delivers in 60 minutes';
                                        }
                                        if (_con.marketReview.rate == '3') {
                                          _con.marketRating =
                                              'Delivers in 45 minutes';
                                        }
                                        if (_con.marketReview.rate == '4') {
                                          _con.marketRating =
                                              'Delivers in 30 minutes';
                                        }
                                        if (_con.marketReview.rate == '5') {
                                          _con.marketRating =
                              ...
                              FlatButton.icon(
                                ...
                                onPressed: () async{
                                  await _con.addMarketReview(_con.marketReview);
                                },
                                shape: StadiumBorder(),
                                label: Text(
                                  S.of(context).submit,
