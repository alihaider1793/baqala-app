...
import '../elements/CircularLoadingWidget1.dart';
            ...
            children: <Widget>[
              ...
              Padding(
                ...
                child: _con.addresses.isEmpty
                    ? CircularLoadingWidget1(height: 250)
                    : ListView.separated(
              ...
              DeliveryAddressesController.noAddress && _con.addresses.isEmpty?
                Padding(padding: const EdgeInsets.only(left: 80, right: 90),
