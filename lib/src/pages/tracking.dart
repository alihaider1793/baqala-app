...
class _TrackingWidgetState extends StateMVC<TrackingWidget> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        bottomNavigationBar: _con.order == null || _con.order.productOrders.isEmpty || _con.order.productOrders == null
                           ? SizedBox(height: 0.0)
                           : Container(
                    ...
                    FlatButton(
                      ...
                      child: Row(
                        ...
                        children: _con.order == null
                                  ? Helper.getStarsList(0.0, size: 35)
                                  : _con.order.productOrders.isEmpty
                                  ? Helper.getStarsList(0.0, size: 35)
                                  : _con.order?.productOrders[0].product?.market?.rate == null
                                  ? Helper.getStarsList(0.0, size: 35)
                                  : Helper.getStarsList(double.parse(_con.order.productOrders[0].product.market.rate), size: 35),
                      ),
                    ),
                  ],
                ),
                                      ...
                                      child: ExpansionTile(
                                        ...
                                        children: <Widget>[
                                          Column(
                                            ...
                                            (indexProduct) {
                                              print(_con.order.productOrders[0].product.name);
