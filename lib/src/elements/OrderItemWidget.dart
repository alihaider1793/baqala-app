...
class OrderItemWidget extends StatefulWidget {
  ...
  OrderItemWidget({Key key, this.expanded, this.order, this.onCanceled, this.showDetails})
      : super(key: key);
                          ...
                          children: <Widget>[
                            ...
                            Row(
                              children: <Widget>[
                                ...
                                Helper.getPrice(
                                    Helper.getOrderServiceFee(widget.order), context,
                                    style:
                                    Theme.of(context).textTheme.subtitle1)
                              ],
                            ),
