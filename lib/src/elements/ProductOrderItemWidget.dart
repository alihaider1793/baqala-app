...
class ProductOrderItemWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // print(this.productOrder.product.name);
    return InkWell(
      splashColor: Theme.of(context).accentColor,
      focusColor: Theme.of(context).accentColor,
      highlightColor: Theme.of(context).primaryColor,
      onTap: () {
        if(this.productOrder.product.name != null)
          {
                ...
                children: <Widget>[
                  Expanded(
                    child: Column(
                      ...
                      children: <Widget>[
                        Text(
                          productOrder.product.name ?? productOrder.productName,
                        ...
                        Text(
                          productOrder.product.market.name ?? productOrder.marketName,
                          overflow: TextOverflow.ellipsis,
                          maxLines: 2,
                          style: Theme.of(context).textTheme.caption,
                        ),
