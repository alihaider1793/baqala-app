...
class CircularLoadingWidget1 extends StatefulWidget {
  final double height;

  CircularLoadingWidget1({Key key, this.height}) : super(key: key);

  @override
  _CircularLoadingWidgetState createState() => _CircularLoadingWidgetState();
}

class _CircularLoadingWidgetState extends State<CircularLoadingWidget1> with SingleTickerProviderStateMixin {
