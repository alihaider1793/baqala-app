...
class S {
  ...
  String get should_be_a_valid_phone {
    return Intl.message(
      'Should be a valid phone',
      name: 'should_be_a_valid_phone',
      desc: '',
      args: [],
    );
  }
  ...
  String get version {
    ...
    print(setting.value.appVersion);
    return Intl.message(
      'Version',
      name: 'version',
      desc: '',
