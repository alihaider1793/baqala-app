...
import 'package:markets/src/elements/PreRegisterFormWidget.dart';
import 'package:markets/src/pages/select_payment_option.dart';
...
import 'src/pages/languages1.dart';
...
class RouteGenerator {
  static Route<dynamic> generateRoute(RouteSettings settings) {
    ...
    switch (settings.name) {
      ...
      case '/RegisterShop':
        return MaterialPageRoute(builder: (_) => RegisterShopWidget());
      case '/ForgetPassword':
      ...
      case '/MyFatoorah':
        return MaterialPageRoute(
            builder: (_) => SelectPaymentOption(
                routeArgument: RouteArgument(param: 'My Fatoorah')));
      case '/PayOnPickup':
        return MaterialPageRoute(
            builder: (_) => OrderSuccessWidget(
      ...
      case '/Languages1':
        return MaterialPageRoute(builder: (_) => LanguagesWidget1());
      case '/Help':
